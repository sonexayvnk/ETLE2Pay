...
public class AgentSettingActivity extends AppCompatActivity {
    GridView gridView;
    ArrayList<ItemSetting> gridArray = new ArrayList<ItemSetting>();

    AgentAdapterSetting customGridAdapter;
    @Override
    ...
    private void LoadItem(){
        ...
        customGridAdapter = new AgentAdapterSetting(this, R.layout.setting_row, gridArray);
        gridView.setAdapter(customGridAdapter);
    }
    public void AdapterClick(final String strText) {
        if (strText.equals("editphoto")) {
            startActivity(new Intent(getApplicationContext(), RegisterNewAgentActivity.class));
        }
    }
    @Override
