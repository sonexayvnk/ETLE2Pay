...
public class AgentBalanceInfoActivity extends AppCompatActivity {
String strMsisdn ;
    @Override
    ...
    public void refresh( ){
        final String  strGetLocation =    GetLocation.get(AgentBalanceInfoActivity.this);
        final Activity act = AgentBalanceInfoActivity.this ;
        ...
        progress_sub.show();
        String url = getString(R.string.str_url_https) + "WalletAgentQueryBalance.php";
    ...
    private void LoadBalance(String Str){
      ...
      //=== 2
        ...
        // ===
        SimpleAdapter sAdap;
        sAdap = new SimpleAdapter(AgentBalanceInfoActivity.this, MyArrList, R.layout.wallet_info_column,
