...
String strMsisdn ;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            ...
            mytext.setText(R.string.str_balance_info);
        } catch (Exception e) {
        }
        return true;
    }
    public void refresh( ){
        final String  strGetLocation =    GetLocation.get(BalanceInfoActivity.this);
        final Activity act = BalanceInfoActivity.this ;
    ...
    private void LoadBalance(String Str){
      ...
      //=== 2
        map = new HashMap<String, String>();
        map.put("Title",getResources().getString(R.string.str_main_balance_wallet)+":");
        map.put("Description", strMainBalance);
        MyArrList.add(map);
        //=== 3
        map = new HashMap<String, String>();
        map.put("Title",getResources().getString(R.string.str_sub_balance_wallet)+":");
        map.put("Description", strSubBalance);
        MyArrList.add(map);
        // ===
        SimpleAdapter sAdap;
        sAdap = new SimpleAdapter(BalanceInfoActivity.this, MyArrList, R.layout.wallet_info_column,
