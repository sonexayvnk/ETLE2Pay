...
public class MerchantAdapterSetting extends ArrayAdapter<ItemSetting> {
    Context context;
    int layoutResourceId;
    ArrayList<ItemSetting> data = new ArrayList<ItemSetting>();
    public MerchantAdapterSetting(Context context, int layoutResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.LinearLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((MerchantSettingActivity)context).AdapterClick(item.getTextKey());
            }
        });
        return row;
    }
