...
public class AgentCashInApproveActivity extends AppCompatActivity {
    ...
    LinearLayout lnlCustomerID, lnlCustomertInfo, lnlAmtInput , lnlVerifycodeInput,lnEnterCode ;
    RadioButton rdoCode, rdoQR ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_agent_cash_in_approve);
        ...
        lnEnterCode = (LinearLayout) findViewById(R.id.lnEnterCode);
 ...
 */
    ...
    private void ConnectAPI(final String StrDestNum) {
        ...
        String url = getString(R.string.str_url_https) + "WalletAgentCashInApprove.php"; // WalletPayment_water_supply
        // Log.e("url_info:", url);
                                    ...
                                    if (strMsisdn.equals(arry[1])) {
                                        ...
                                        if (arry[3].equals("LoadInfo")) {
                                           ...
                                           // lnlAmtInput.setVisibility(View.VISIBLE);
                                            ...
                                            float floDebit =Float.parseFloat(arry[8]);
                                            ...
                                            if (rdoCode.isChecked()) {
                                                Str += getString(act, "str_cash_in_code_query") + ";" + arry[9] + "|";
                                            }else{
                                            ...
                                            Str += getResources().getString(R.string.str_name) +";"+ arry[5]+ " "+ arry[6] +"|";
                                          //  Str += getResources().getString(R.string.str_date_of_birth)+";"+arry[7]+"|";
                                            Str += getResources().getString(R.string.str_amount)+";"+strDebitAmount+"|";
                                         ...
                                         /*   lnlAmtInput.setVisibility(View.GONE);
                                            ...
                                            lnlVerifycodeInput.setVisibility(View.VISIBLE);
                                            //StrStepOPT = "4" ;
                                            String str = getString(act, "str_you_have_successful_for_cash_in_to_end_user");
 ...
 */
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (!str.equals("")){
            ...
            referenceID = arry[5];
            onClickSubmitAgentCashInApprove();
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            ...
            mytext.setText( getResources().getString(R.string.str_agent_cash_in_approve) );
            imgBill.setImageResource(getResources().getIdentifier("drawable/"+"bill_"+ActivityKey, null, getPackageName()));
            txtCustomerID.setHint( getString(this, "str_cash_in_code_query"));
...
/*
        ...
        */
        ...
        for (String str : arryData) {
          ...
          //  // System.out.print("Print2021: "+ArrB[0]+" ~ "+ ArrB[1]);
         //   Log.e("Print2021: ",  ArrB[0]+" ~ "+ ArrB[1]);
            // dialog("Print2021: "+ArrB[0]+" ~ "+ ArrB[1], 1);
            arrayList.add(new CashData(2, ArrB[0]+":",""+ ArrB[1],"",""));
            // arrayList.add(new CashData(2, "Amount"+":",""+ "100,000","",""));
        }
    ...
    public void onClickSubmitAgentCashInApprove(View v) {
        onClickSubmitAgentCashInApprove();
    }
    public void onClickSubmitAgentCashInApprove() {
        ...
        if (StrStepOPT.equals("1")){ // === Query info
            ...
            if (rdoCode.isChecked()) {
                ...
                if (strCustomerWalletNumber.trim().length() < 2 ) {
                    ...
                    new IntentIntegrator(AgentCashInApproveActivity.this).setDesiredBarcodeFormats(IntentIntegrator.QR_CODE_TYPES).setCaptureActivity(ScannerActivity.class).initiateScan();
          ...
          /*  String EnterEtlPaymentVerifycode = txtEnterEtlPaymentVerifycode.getText().toString();
            ...
            alert.setMessage(getString(this, "str_you_would_like_to_cash_in_for_this_end_user"));
