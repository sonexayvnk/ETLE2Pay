...
public class AgentCashOutApproveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agent_cash_out_approve);
 ...
 */
    ...
    private void ConnectAPI(final String StrDestNum) {
        ...
        String url = getString(R.string.str_url_https) + "WalletAgentCashOuApprove.php"; // WalletPayment_water_supply
        // Log.e("url_info:", url);
                                ...
                                if (arry[0].equals("405000000")) {
                                    ...
                                    if (strMsisdn.equals(arry[1])) {
                                        ...
                                        if (arry[3].equals("LoadInfo")) {
                                            ...
                                            float cashoutAmt =Float.parseFloat(arry[8]);
                                            txtEnterPaymentAmount.setText(cashoutAmt+"");
                                            float feeAmt =Float.parseFloat(arry[10]);
                                         ...
                                         /*   lnlAmtInput.setVisibility(View.GONE);
                                            ...
                                            lnlVerifycodeInput.setVisibility(View.VISIBLE);
                                            //StrStepOPT = "4" ;
                                            String str = getString(act, "str_you_have_successful_for_cash_out_to_end_user");
...
*/
            ...
            if (rdoCode.isChecked()) {
                ...
                if (strCustomerWalletNumber.trim().length() < 2) {
                    ...
                    new IntentIntegrator(AgentCashOutApproveActivity.this).setDesiredBarcodeFormats(IntentIntegrator.QR_CODE_TYPES).setCaptureActivity(ScannerActivity.class).initiateScan();
