...
public class MerchantCashOutRequestActivity extends AppCompatActivity {
...
Context context ;
    ...
    private void ConnectAPI(final String StrDestNum) {
        ...
        progress_sub.show();
         String url = getString(R.string.str_url_https) + "WalletMercahntCashOutRequest.php"; // WalletPayment_water_supply
        // Log.e("url_info:", url);
