 ...
 */
    ...
    private void ConnectAPI(final String StrDestNum) {
        ...
        String url = getString(R.string.str_url_https) + "WalletEndUserCashOutRequest.php"; // WalletPayment_water_supply
        // Log.e("url_info:", url);
                                        ...
                                        if (arry[3].equals("LoadInfo")) {
                                         ...
                                         String   str = strCustomerInfo.split("\\|")[0];
                                           ...
                                           // str += "|"+strCustomerInfo.split("\\|")[4]+"|";
                                            ...
                                            String strQrTypeName  = getResources().getString(R.string.str_enduser_cashout);
                                         ...
                                         Intent refresh1 = new Intent(getApplicationContext(), AutoGenerateQRCode.class);
                                            ...
                                            lnlVerifycodeInput.setVisibility(View.VISIBLE);
                                            //StrStepOPT = "4" ;
                                            String str = getString(act, "str_you_have_successful_for_send_request_cash_out");
                                            dialog(str, 1);  // 1:Success, 2:Fail, 3:Error
                                            LoadCustomerInfo("");
                                            ClearTextEtlPayment();
...
/*
    ...
    public void onClickSubmitEndUserCashOut(View v) {
        ...
        if (StrStepOPT.equals("1")){ // === Query info
            ...
            alert.setMessage(getString(this, "str_you_would_like_to_sent_request_cash_out"));
