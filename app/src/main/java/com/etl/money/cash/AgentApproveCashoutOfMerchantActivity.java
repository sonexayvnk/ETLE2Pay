...
public class AgentApproveCashoutOfMerchantActivity extends AppCompatActivity {
    ...
    EditText txtEnterPaymentAmount, txtCustomerWalletNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agent_approve_cashout_of_merchant);
        ...
        txtCustomerWalletNumber = (EditText) findViewById(R.id.txtCustomerWalletNumber);
        ...
        rdoCode.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                chooseOTPorQR();
            }
        });
        rdoQR.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                chooseOTPorQR();
            }
        });
 ...
 */
    ...
    private void ConnectAPI(final String StrDestNum) {
        ...
        String url = getString(R.string.str_url_https) + "WalletAgentCashInApproveOfMerchant.php"; // WalletPayment_water_supply
        // Log.e("url_info:", url);
                                ...
                                if (arry[0].equals("405000000")) {
                                    ...
                                    if (strMsisdn.equals(arry[1])) {
                                        ...
                                        if (arry[3].equals("LoadInfo")) {
                                            ...
                                            float cashoutAmt =Float.parseFloat(arry[6]);
                                            txtEnterPaymentAmount.setText(cashoutAmt+"");



//0|1|2|3|4|$customerName5|$cashInRequestAmount6|$secureCode7");
                                            String strAmount =   new DecimalFormat("#,###,###").format(cashoutAmt);
                                            ...
                                            if (rdoCode.isChecked()) {
                                                Str += getString(act, "str_cash_in_code_query") + ";" + arry[7] + "|";
                                            }else{
                                                Str += getString(act, "str_cash_in_code_query") + ";" + referenceID + "|";
                                            }


                                            Str += getString(act, "str_customer_mobile_numbere")+";" +txtCustomerWalletNumber.getText()+"|";
                                            Str += getResources().getString(R.string.str_name) +";"+ arry[5] +"|";
                                            // Str += getResources().getString(R.string.str_date_of_birth)+";"+arry[7]+"|";
                                            Str += getResources().getString(R.string.str_amount)+";"+strAmount+"|";


                                            strCustomerInfo = Str;
                                            // Log.e("strCustomerInfo:", strCustomerInfo);
                                         ...
                                         /*   lnlAmtInput.setVisibility(View.GONE);
                                            ...
                                            lnlVerifycodeInput.setVisibility(View.VISIBLE);
                                            //StrStepOPT = "4" ;
                                            String str = getString(act, "str_you_have_successful_for_cash_out_to_merchant");
            ...
            protected Map<String, String> getParams() {
                ...
                if (StrVerifyType.equals("1")) { // 1=OTP, 2=PSW
                    if (StrStepOPT.equals("1")) {  // LoadInfo
                        strBasic_info += "|" + StrDestNum +"|"+txtCustomerWalletNumber.getText().toString();
                       ...
                       /* StrPublickey = "GetOTP";
                        ...
                        strBasic_info += "|" + StrDestNum +"|"+txtCustomerWalletNumber.getText().toString()+"|"+txtEnterPaymentAmount.getText().toString();
                    }
                }
                CryptoHelper cryptoHelper = new CryptoHelper();
...
//        3	Finger print
    ...
    private void chooseOTPorQR(){
        if (rdoCode.isChecked()) {
            //  lnEnterCode.setVisibility(View.VISIBLE);
            txtCustomerIDForPaymentView.setVisibility(View.VISIBLE);
            txtCustomerID.setVisibility(View.VISIBLE);
            txtCustomerWalletNumber.setEnabled(true);
            txtCustomerWalletNumber.setBackgroundResource(R.drawable.text_border_stype);
        }else{
            // lnEnterCode.setVisibility(View.GONE);
            txtCustomerWalletNumber.setBackgroundResource(R.drawable.text_border_stype_for_enable);
            txtCustomerWalletNumber.setEnabled(false);
            txtCustomerIDForPaymentView.setVisibility(View.GONE);
            txtCustomerID.setVisibility(View.GONE);
        }
    }

    public void onClickSubmitAgentCashOutApprove(View v) {
        onClickSubmitAgentCashOutApprove();
    }
    public void onClickSubmitAgentCashOutApprove() {
        // Log.e("StrStepOPT20210409:",  StrStepOPT);
        if (StrStepOPT.equals("1")){ // === Query info
            // StrStepOPT = "1" ;
            /*String strCustomerWalletNumber = txtCustomerWalletNumber.getText().toString();
            String strDestNum = txtCustomerID.getText().toString();
            if (strCustomerWalletNumber.trim().length() < 2 ) {
                txtCustomerWalletNumber.requestFocus();
                String str = getString(R.string.str_please_enter) +", "+ getString(R.string.str_customer_mobile_numbere);
                txtCustomerWalletNumber.setError(str);
                return;
            } else  if (strDestNum.trim().length() < 2 ) {
                txtCustomerID.requestFocus();
                String str = getString(R.string.str_please_enter) +", "+  getString(R.string.str_cash_in_code);
...
*/
            ...
            if (rdoCode.isChecked()) {
                ...
                if (strCustomerWalletNumber.trim().length() < 2) {
                    ...
                    new IntentIntegrator(AgentApproveCashoutOfMerchantActivity.this).setDesiredBarcodeFormats(IntentIntegrator.QR_CODE_TYPES).setCaptureActivity(ScannerActivity.class).initiateScan();
          ...
          /*  String EnterEtlPaymentVerifycode = txtEnterEtlPaymentVerifycode.getText().toString();
            ...
            alert.setMessage(getString(this, "str_you_would_like_to_cash_out_for_this_end_user"));
    ...
    private void ClearTextEtlPayment() {
        ...
        StrStepOPT="1";
        String data = helper.getData(ActivityKey);
        txtCustomerWalletNumber.setText("");
        txtEnterPaymentAmount.setText("0");
 ...
 */
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (result.getContents() != null) {
            ...
            str= pref.getString(GlabaleParameter.PREFS_QR_CODE_GALLERY_NUMBER, "");
        ...
        if (!str.equals("")){
            ...
            txtCustomerWalletNumber.setText(arry[0]);
            txtCustomerID.setText(arry[4]);
            referenceID = arry[5];
            onClickSubmitAgentCashOutApprove();
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            ...
            mytext.setText( getResources().getString(R.string.str_agent_cash_out_approve) );
            imgBill.setImageResource(getResources().getIdentifier("drawable/"+"bill_"+ActivityKey, null, getPackageName()));
            txtCustomerID.setHint( getString(this, "str_cash_out_code_query"));
            txtCustomerIDForPaymentView.setText( getString(this, "str_enter_cash_in_code"));
