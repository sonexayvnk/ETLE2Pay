...
public class AgentHistoryWalletActivity extends AppCompatActivity {
    String StrMobileNumber ;
    private AgentHistoryWalletAdapter HistoryAdapter;
    Context context;
...
/*  boolean loadingMore = false;
    ...
    AgentHistoryWalletAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AgentHistoryWalletAdapter(AgentHistoryWalletActivity.this, newsList);
    ...
    private void customer_history_request(String strfrom) {
        ...
        final String  strGetLocation =    GetLocation.get(AgentHistoryWalletActivity.this);
...
// To dismiss the dialog
        String url = getString(R.string.str_url_https) + "WalletAgentHistory.php";
         Log.e("url:", url);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() {
               ...
               // Log.e("Active_valuesHistory", strBasic_info);
