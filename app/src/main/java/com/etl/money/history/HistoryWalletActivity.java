...
public class HistoryWalletActivity extends AppCompatActivity {
    ...
    private HistoryWalletAdapter HistoryAdapter;
    Context context;
...
/*  boolean loadingMore = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mytext.setText(R.string.title_activity_history);
        } catch (Exception e) {
        }
        ...
        newsList.clear();
        adapter = new HistoryWalletAdapter(HistoryWalletActivity.this, newsList);
    ...
    private void customer_history_request(String strfrom) {
        ...
        final String  strGetLocation =    GetLocation.get(HistoryWalletActivity.this);
...
// To dismiss the dialog
        String url = getString(R.string.str_url_https) + "WalletHistory.php";
        // Log.e("url:", url);
