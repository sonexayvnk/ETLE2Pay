 ...
 */
public class AgentHistoryWalletAdapter extends BaseAdapter {



    AgentHistoryWalletAdapter(Context p_context)
    {
        context=p_context;
    }
    ...
    public AgentHistoryWalletAdapter(Activity activity, List<HistoryWalletData> newsItems) {this.activity = activity;this.newsItems = newsItems;}
    @Override
    public int getCount() {
    ...
    public View getView(   final int position, View convertView, ViewGroup parent) {
     ...
     //   txtAmount.setText(StrAmt);
       ...
       // View1.setVisibility(View.GONE);
        ...
        historyDetial.setOnClickListener(new View.OnClickListener() {@Override public void onClick(View v) { ((AgentHistoryWalletActivity)activity).historyDetal(newsItems.get(position).gettxtDetail()); }});
        txtCirclesTitle.setOnClickListener(new View.OnClickListener() {@Override public void onClick(View v) { ((AgentHistoryWalletActivity)activity).historyDetal(newsItems.get(position).gettxtDetail()); }});
        txtSubject.setOnClickListener(new View.OnClickListener() {@Override public void onClick(View v) { ((AgentHistoryWalletActivity)activity).historyDetal(newsItems.get(position).gettxtDetail()); }});
        Description.setOnClickListener(new View.OnClickListener() {@Override public void onClick(View v) { ((AgentHistoryWalletActivity)activity).historyDetal(newsItems.get(position).gettxtDetail()); }});
        txtDatetine.setOnClickListener(new View.OnClickListener() {@Override public void onClick(View v) { ((AgentHistoryWalletActivity)activity).historyDetal(newsItems.get(position).gettxtDetail()); }});
        txtAmount.setOnClickListener(new View.OnClickListener() {@Override public void onClick(View v) { ((AgentHistoryWalletActivity)activity).historyDetal(newsItems.get(position).gettxtDetail()); }});
